...
object music_releases extends Target:
    ...
    wrapHeader:
      tags2.main(
        ...
        *.cls := "items-center",
        ...
        p.withStyles(*.cls := "max-w-xl", *.cls := "text-center", *.cls := "mb-0")(
  ...
  val releases: List[Release] = List(
    Release(
      ...
      bandCamp = Some("https://alistairthemany.bandcamp.com/album/half-past-never"),
      content = 
        frag"""
          ...
          ${credits(
            ...
            li("""Martin Hackett, Korg MS-20 on "crystal hexagons that don't melt".""""),
            li("""Tim Straubinger, databending on "crystal hexagons that don't melt".""""),
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/no-clicks-at-all-there-it-is"),
      content = 
        frag"""
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/kinda-strictly-sorta-maybe"),
      content = 
        frag"""
          I guess...
          ...
          ${credits(
            li("Martin Hackett, Korg MS-20 played on \"monsieur hulot's pipe machine\"."),
            li("Onkle Honky, horn demo on \"monsieur hulot's pipe machine\"."),
            li("[redacted] Airlines, announcements on \"that's not wensleydale, gromit!\", \"modern glass\", and \"mercury\"."),
            li("Shayan Hosseini, academic presentation resampled on \"boat trip in amber\"."),
          )}
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/athenas-playground"),
      content =
        frag"""
          ...
          ${credits(
            ...
            li("""Tim Straubinger: very nice.zip data bending on "avcodec mangrove nice" and "very nice digital mold.mkl_core""""),
            li("""Alex Trostanovsky: guitar and a MIDI clip on "triangle sound""""),
            li("""Shaurya Patel: spoken word on "an iridescent manifold", spoken word and Sitar on "very nice digital mold.mkl_core" and "one more time""""),
          )}
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/the-mountain-underground"),
      content =
        frag"""
          ...
          ${credits(
            li("Kira Potter - comments on in-progress drafts, concept for the title."),
            li("Martin Hackett - one of his paintaings is partially visible in the album art."),
          )}
          """,
    ),
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/living-elements"),
      content =
        frag"""
          ...
          ${credits(
            ...
            li("""Martin Hackett: Korg MS-10 on "dirty sunrise" and "controlling the media""""),
            li("""Kira Potter: vocals on "controlling the media" and "panpipes""""),
            li("""Preeti Vyas: field recordings on "beachside" and "it's not that far"; vocals on "beachside"; spoken word on "it's not that far""""),
            li("""Zach Morgenstern: vocals on "blurry sunshine", "a hollow in the earth", and "green ball of energy"; guitar on "a hollow in the earth" and "green ball of energy""""),
          )}
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/water-in-bloom"),
      content =
        frag"""
          ...
          ${credits(
            li("""Tim Straubinger, a variety of short impacts and household items"""),
            li("""Ivan Beschasnikh, some of the longer-form environmental field recordings, most notably on floating forest"""),
          )}
        """,
    ),
    Release(
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/pixellated-beach"),
      content =
        frag"""
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/alien-adventure"),
      content =
        frag"""
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/morning-greyshadow"),
      content =
        frag"""
    ...
    Release(
      ...
      soundCloud = Some("https://soundcloud.com/finnhackett/sets/sky-in-the-fish-version"),
      content = 
        frag"""
